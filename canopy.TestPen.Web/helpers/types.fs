...
type PassedTests = JsonProvider<"""[{"area":{"Case":"Configuration"},"section":{"Case":"General"},"name":"Publish Rules","testName":"yada"}, {"area":{"Case":"Configuration"},"section":{"Case":"General"},"name":"Publish Rules","testName":"lada"}]""">

type getCasesResult = { 
    ClaimedBy : string option
    CaseId : int
    Area : string
    Section : string
    Name : string
